      ...
      <Fragment>
        ...
        <div className="results__container">
          <div className="results__top">
            ...
            <h4 className="results__top__thirdtitle result__locationDpto">Cobertura: {cobertura && cobertura.label} - Período ({periodicidad && periodicidad.label}): {periodo.label} </h4>
